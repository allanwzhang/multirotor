...
class Wind_Model():
    ...
    def find_wind_vec(self, sample_time, veh_speed, height, turbulence, _show=False, _save=False):
        ...
        if index not in self.wind_vec_list:
            self.wind_vec_list[index] = self.dryden_wind_velocities(veh_speed, height, turbulence, show_figs=_show, save_figs=_save)

        return self.wind_vec_list[index]
        

    def get_wind_vector(self, veh_speed, height, turbulence, sample_time : float, base_wind_vec: list, show=False, save=False):
        ...
        time, x_wind, y_wind, z_wind = self.find_wind_vec(sample_time, veh_speed, height, turbulence, show, save)
